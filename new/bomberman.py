...
class bomberman(Board, bricks, Enemy, Bomb):
    ...
    def moveBomberman(self):
        ...
        if key == 'a' and Board.board[self.x][self.y - 5] != "X" \
            and Board.board[self.x][self.y - 5] != "/" and \
                Board.board[self.x][self.y - 5] != "e":
            # for u in range(0,4):
        ...
        if key == "d" and Board.board[self.x][self.y + 3] != "X" \
            and Board.board[self.x][self.y + 3] != "/" \
                and Board.board[self.x + 1][self.y + 3] != "e":
        ...
        if key == "w" and Board.board[self.x - 2][self.y] != "X" \
            and Board.board[self.x - 2][self.y] != "/" \
                and Board.board[self.x - 2][self.y] != "e":
        ...
        if key == "s" and Board.board[self.x + 2][self.y] != "X" \
            and Board.board[self.x + 2][self.y] != "/" \
                and Board.board[self.x + 2][self.y] != "e":
            Board.board[self.x + 2][self.y - 1] = "["
            Board.board[self.x + 2][self.y] = "^"
